...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Double[] vectorCm = new Double[count]; //M de menos ok
        ...
        for(i=0; i< vectorCm.length; i++){
            vectorCm[i] = vectorA[i] - vectorB[i];
        }
        ...
        System.out.println("\\n\nVector C: ");
        for(i=0; i< vectorCm.length; i++){
            System.out.print(vectorCm[i].intValue() + " | ");
        }
    }
}